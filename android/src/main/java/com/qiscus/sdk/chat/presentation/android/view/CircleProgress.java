...
import com.qiscus.sdk.chat.presentation.android.util.UiUtilKt;
...
public class CircleProgress extends View {
    ...
    public CircleProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        defaultTextSize = UiUtilKt.sp2px(getResources(), 18);
        minSize = (int) UiUtilKt.dp2px(getResources(), 100);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        textColor = attributes.getColor(R.styleable.CircleProgress_circle_text_color, defaultTextColor);
        textSize = attributes.getDimension(R.styleable.CircleProgress_circle_text_size, defaultTextSize);

        setMax(attributes.getInt(R.styleable.CircleProgress_circle_max, defaultMax));
