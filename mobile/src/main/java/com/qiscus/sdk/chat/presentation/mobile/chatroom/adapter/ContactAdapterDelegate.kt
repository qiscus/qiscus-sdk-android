 ...
 */
class ContactAdapterDelegate @JvmOverloads constructor(private val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_qiscus_message_contact_me, parent, false)
        return ContactViewHolder(view, itemClickListener, itemLongClickListener)
    }
}

open class ContactViewHolder @JvmOverloads constructor(view: View,
