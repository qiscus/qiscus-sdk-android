 ...
 */
class OpponentCardAdapterDelegate(private val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        ...
        return OpponentCardViewHolder(view, itemClickListener, chatButtonClickListener)
    }
}

open class OpponentCardViewHolder(view: View,
                                  itemClickListener: ItemClickListener? = null,
                                  private val chatButtonClickListener: ChatButtonView.ChatButtonClickListener)
    : OpponentTextViewHolder(view, itemClickListener) {
