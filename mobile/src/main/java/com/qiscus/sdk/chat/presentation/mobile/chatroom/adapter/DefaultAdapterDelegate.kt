 ...
 */
class DefaultAdapterDelegate @JvmOverloads constructor(private val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_qiscus_message_text_me, parent, false)
        return TextViewHolder(view, itemClickListener, itemLongClickListener)
    }
}

class DefaultMultiLineAdapterDelegate @JvmOverloads constructor(private val context: Context,
                                                                private val itemClickListener: ItemClickListener? = null,
                                                                private val itemLongClickListener: ItemLongClickListener? = null)
    : MessageAdapterDelegate() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_qiscus_message_multi_line_text_me, parent, false)
        return TextViewHolder(view, itemClickListener, itemLongClickListener)
    }
}