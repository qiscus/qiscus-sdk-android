 ...
 */
class OpponentCardAdapterDelegate @JvmOverloads constructor(private val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_qiscus_message_card, parent, false)
        return OpponentCardViewHolder(view, itemClickListener, itemLongClickListener)
    }
}

open class OpponentCardViewHolder @JvmOverloads constructor(view: View,
