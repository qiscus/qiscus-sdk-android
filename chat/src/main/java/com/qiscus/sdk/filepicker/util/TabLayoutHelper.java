...
public class TabLayoutHelper {
    ...
    private void handleOnDataSetChanged() {
        ...
        if (setTabsFromPagerAdapterRunnable == null) {
            setTabsFromPagerAdapterRunnable = () -> setTabsFromPagerAdapter(tabLayout, viewPager.getAdapter(), viewPager.getCurrentItem());
        }
    ...
    private void setTabsFromPagerAdapter(@NonNull TabLayout tabLayout, @Nullable PagerAdapter adapter, int currentItem) {
        try {
