...
public class QiscusChatPresenter extends QiscusPresenter<QiscusChatPresenter.View> implements QiscusChatRoomEventHandler.StateListener {
    ...
    private Func2<QMessage, QMessage, Integer> commentComparator = (lhs, rhs) -> rhs.getTime().compareTo(lhs.getTime());
    ...
    private void commentSuccess(QMessage qiscusComment) {
        ...
        QMessage savedQiscusComment = Qiscus.getDataStore().getComment(qiscusComment.getUniqueId());
    ...
    private void commentFail(Throwable throwable, QMessage qiscusComment) {
        ...
        QMessage savedQiscusComment = Qiscus.getDataStore().getComment(qiscusComment.getUniqueId());
        if (savedQiscusComment != null && savedQiscusComment.getState() > QMessage.STATE_SENDING) {
            return;
        }
