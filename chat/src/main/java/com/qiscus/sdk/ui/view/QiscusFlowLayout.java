...
public class QiscusFlowLayout extends ViewGroup {
    ...
    public QiscusFlowLayout(Context context) {
        super(context);
        this.config = new LayoutConfiguration(context, null);
    }

    public QiscusFlowLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.config = new LayoutConfiguration(context, attributeSet);
    }

    public QiscusFlowLayout(Context context, AttributeSet attributeSet, int defStyle) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (this.config.getOrientation() == QiscusFlowLayout.HORIZONTAL) {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        private void readStyleParameters(Context context, AttributeSet attributeSet) {
            TypedArray a = context.obtainStyledAttributes(attributeSet, R.styleable.QiscusFlowLayout_LayoutParams);
            try {
                this.newLine = a.getBoolean(R.styleable.QiscusFlowLayout_LayoutParams_layout_newLine, false);
                this.gravity = a.getInt(R.styleable.QiscusFlowLayout_LayoutParams_android_layout_gravity, Gravity.NO_GRAVITY);
                this.weight = a.getFloat(R.styleable.QiscusFlowLayout_LayoutParams_layout_weight, -1.0f);
            } finally {
                a.recycle();
            }
        }
        ...
        int getSpacingLength() {
            if (orientation == QiscusFlowLayout.HORIZONTAL) {
