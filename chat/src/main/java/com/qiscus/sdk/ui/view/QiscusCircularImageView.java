...
public class QiscusCircularImageView extends ImageView {
    ...
    public QiscusCircularImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.QiscusCircularImageView, defStyle, 0);

        borderWidth = a.getDimensionPixelSize(R.styleable.QiscusCircularImageView_qciv_border_width, DEFAULT_BORDER_WIDTH);
        borderColor = a.getColor(R.styleable.QiscusCircularImageView_qciv_border_color, DEFAULT_BORDER_COLOR);
        borderOverlay = a.getBoolean(R.styleable.QiscusCircularImageView_qciv_border_overlay, DEFAULT_BORDER_OVERLAY);
        fillColor = a.getColor(R.styleable.QiscusCircularImageView_qciv_fill_color, DEFAULT_FILL_COLOR);
