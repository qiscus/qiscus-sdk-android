...
public class QiscusContactViewHolder extends QiscusBaseContactViewHolder {
    public QiscusContactViewHolder(View itemView, OnItemClickListener itemClickListener,
    ...
    @NonNull
    @Override
    public TextView getContactNameView(View itemView) {
        return (TextView) itemView.findViewById(R.id.contact_name);
    }

    @NonNull
    @Override
    public TextView getContactIdView(View itemView) {
        return (TextView) itemView.findViewById(R.id.contact_id);
    }
