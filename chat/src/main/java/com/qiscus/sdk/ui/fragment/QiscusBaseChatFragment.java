...
public abstract class QiscusBaseChatFragment<T extends QiscusBaseChatAdapter> extends RxFragment
    ...
    protected void accountLinkingClick(QiscusComment qiscusComment) {
        try {
            ...
            startActivity(QiscusAccountLinkingActivity.generateIntent(getActivity(), payload.optString("view_title"),
                    payload.getString("url"), payload.getString("redirect_url"), payload.optString("success_message")));
