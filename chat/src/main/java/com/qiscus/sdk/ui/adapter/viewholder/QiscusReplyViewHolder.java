...
public class QiscusReplyViewHolder extends QiscusBaseReplyMessageViewHolder {
    ...
    public QiscusReplyViewHolder(View itemView, OnItemClickListener itemClickListener,
                                 OnLongItemClickListener longItemClickListener, ReplyItemClickListener replyItemClickListener) {
        super(itemView, itemClickListener, longItemClickListener, replyItemClickListener);
    }

    @NonNull
    @Override
    protected ViewGroup getOriginMessageView(View itemView) {
        return (ViewGroup) itemView.findViewById(R.id.origin_message);
    }

    @NonNull
    @Override
    protected TextView getOriginSenderTextView(View itemView) {
        return (TextView) itemView.findViewById(R.id.origin_sender);
    }

    @NonNull
    @Override
    protected TextView getOriginMessageTextView(View itemView) {
        return (TextView) itemView.findViewById(R.id.origin_content);
    }

    @Nullable
    @Override
    protected View getBarView(View itemView) {
        return itemView.findViewById(R.id.bar);
    }

    @Nullable
    @Override
    protected ImageView getOriginIconView(View itemView) {
        return (ImageView) itemView.findViewById(R.id.icon);
    }

    @Nullable
    @Override
    protected ImageView getOriginImageView(View itemView) {
        return (ImageView) itemView.findViewById(R.id.origin_image);
    }
