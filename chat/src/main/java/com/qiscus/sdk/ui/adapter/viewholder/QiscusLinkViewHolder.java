 ...
 */
public class QiscusLinkViewHolder extends QiscusBaseLinkViewHolder {
    public QiscusLinkViewHolder(View itemView, OnItemClickListener itemClickListener, OnLongItemClickListener longItemClickListener) {
        super(itemView, itemClickListener, longItemClickListener);
    }

    @NonNull
    @Override
    protected QiscusLinkPreviewView getLinkPreviewView(View itemView) {
        return (QiscusLinkPreviewView) itemView.findViewById(R.id.preview);
    }
