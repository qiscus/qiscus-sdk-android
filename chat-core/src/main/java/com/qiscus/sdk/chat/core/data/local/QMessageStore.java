 ...
 */
public interface QMessageStore {
    void add(QMessage qiscusMessage);

    boolean isContains(QMessage qiscusMessage);

    void update(QMessage qiscusMessage);

    void addOrUpdate(QMessage qiscusMessage);

    void delete(QMessage qiscusMessage);
    ...
    List<QMessage> getOlderCommentsThan(QMessage qiscusMessage, long roomId, int limit);

    Observable<List<QMessage>> getObservableOlderCommentsThan(QMessage qiscusMessage, long roomId, int limit);

    List<QMessage> getCommentsAfter(QMessage qiscusMessage, long roomId);

    Observable<List<QMessage>> getObservableCommentsAfter(QMessage qiscusMessage, long roomId);
