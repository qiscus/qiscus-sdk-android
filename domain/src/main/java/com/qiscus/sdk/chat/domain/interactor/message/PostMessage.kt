 ...
 */
class PostMessage(private val messageRepository: MessageRepository,
                  threadExecutor: ThreadExecutor, postExecutionThread: PostExecutionThread) :
        CompletableUseCase<PostMessage.Params>(threadExecutor, postExecutionThread) {

    override fun buildUseCaseObservable(params: PostMessage.Params?): Completable {
        return messageRepository.postMessage(params!!.message)
    }
