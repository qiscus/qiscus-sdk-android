 ...
 */
class ListenMessageState(private val messageObserver: MessageObserver,
                         threadExecutor: ThreadExecutor, postExecutionThread: PostExecutionThread)
    : ObservableUseCase<Message, ListenMessageState.Params?>(threadExecutor, postExecutionThread) {

    override fun buildUseCaseObservable(params: ListenMessageState.Params?): Observable<Message> {
        return messageObserver.listenMessageState(params!!.roomId)
    }
