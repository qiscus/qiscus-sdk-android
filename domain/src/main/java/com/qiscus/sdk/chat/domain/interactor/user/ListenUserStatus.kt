 ...
 */
class ListenUserStatus(private val userObserver: UserObserver,
                       threadExecutor: ThreadExecutor, postExecutionThread: PostExecutionThread)
    : ObservableUseCase<UserStatus, ListenUserStatus.Params>(threadExecutor, postExecutionThread) {

    override fun buildUseCaseObservable(params: Params?): Observable<UserStatus> {
        return userObserver.listenUserStatus(params!!.userId)
    }
