...
data class SearchMessageResponseModel(var results: Results, var status: Int) {
    ...
    data class Comment(
        ...
        fun toEntity(): MessageEntity {
            return MessageEntity(
                    ...
                    MessageStateEntity.ON_SERVER, MessageTypeEntity(type, if (!payload.isJsonNull) JSONObject(payload.toString()) else JSONObject())
