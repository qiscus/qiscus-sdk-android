...
data class MessageResponseModel(var results: Results, var status: Int) {
    ...
    data class Comment(
        ...
        fun toEntity(): MessageEntity {
            return MessageEntity(
                    ...
                    MessageTypeEntity(type, if (!payload.isJsonNull) JSONObject(payload.toString()) else JSONObject())
