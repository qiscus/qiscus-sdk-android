 ...
 */
open class MessageButtonsViewModel(message: Message) : MessageViewModel(message) {
    ...
    companion object CREATOR : Parcelable.Creator<MessageButtonsViewModel> {
        override fun createFromParcel(parcel: Parcel): MessageButtonsViewModel {
            return MessageButtonsViewModel(parcel)
        }

        override fun newArray(size: Int): Array<MessageButtonsViewModel?> {
